                ...
                <div className="footer-group">
                    ...
                    <p className="m-0">
                        <a href="mailto:razvan.cirlugea@gmail.com">
                            ...
                            ionut.dita01@gmail.com
                        </a>
                    </p>
                    <p className="m-0"><Phone className="mr-1 footer-icon"/>+40764708741</p>
                </div>
                <div className="footer-group">
                    <h3 className="h5">Contactează-mă:</h3>
                    <p className="m-0">
                        <a href="https://github.com/ditaionut">
                            <GitHub className="mr-1 mb-1 footer-icon"/>
                            ditaionut
                        </a>
                    </p>
                    <p className="m-0">
                        <a href="https://www.linkedin.com/in/ionutdita/">
